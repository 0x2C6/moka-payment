...
module Moka
  module Request
    ...
    def self.get_check_key(dealer_code, username, password)
    ...
    def self.direct_payment(payment_details)
      ...
      response = RestClient.post 'https://service.testmoka.com/PaymentDealer/DoDirectPayment',
      {
